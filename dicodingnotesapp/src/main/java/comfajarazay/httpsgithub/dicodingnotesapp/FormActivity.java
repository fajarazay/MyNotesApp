package comfajarazay.httpsgithub.dicodingnotesapp;
...
import comfajarazay.httpsgithub.dicodingnotesapp.db.DatabaseContract;
import comfajarazay.httpsgithub.dicodingnotesapp.entity.NoteItem;

import static comfajarazay.httpsgithub.dicodingnotesapp.db.DatabaseContract.CONTENT_URI;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit) {
            ...
            if (!isEmptyField) {
                ...
                mContentValues.put(
                        DatabaseContract.NoteColumns.DATE, getCurrentDate());
